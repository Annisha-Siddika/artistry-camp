...
const ClassCard = ({ singleClass }) => {
  ...
  return (
    <Fade>
      <div
        className="card card-compact shadow-xl w-3/4 md:w-full h-full mx-auto bg-fuchsia-950 relative text-white"
        style={cardStyle}
      >
  ...
  disabled={selected || singleClass.seats === 0 || isAdmin}
  className={`${
    selected || singleClass.seats === 0 || isAdmin
      ? "absolute top-2 right-2 bg-gray-600 btn-circle text-4xl flex items-center justify-center"
      : "absolute top-2 right-2 border-2 border-fuchsia-950 btn-circle text-4xl flex items-center text-green-700 bg-white justify-center"
  }`}
>

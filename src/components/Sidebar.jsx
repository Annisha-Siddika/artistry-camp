            ...
            <div>
                ...
                <ul className='flex flex-col justify-between flex-1 mt-6'>
...

                    {
                        isAdmin ? (
                            <>
                                <Link to='/dashboard/manage-classes' className='flex items-center gap-4 hover:bg-gray-200 p-2 mb-2'> <HiViewGridAdd className='w-5 h-5' /><span>Manage Classes</span></Link>
                                <Link className='flex items-center gap-4 hover:bg-gray-200 p-2 mb-2'> <HiViewGridAdd className='w-5 h-5' /><span>Manage Users</span></Link>
                            </>
                        ):(
                            isInstructor ? (
                            <>
                                ...
                                <Link className='flex items-center gap-4 hover:bg-gray-200 p-2 mb-2'> <HiViewGridAdd className='w-5 h-5' /><span>My Classes</span></Link>
                            </>
                            ):(
                            <>
                                <Link className='flex items-center gap-4 hover:bg-gray-200 p-2 mb-2'> <HiViewGridAdd className='w-5 h-5' /><span>My Selected Classes</span></Link>
                                <Link className='flex items-center gap-4 hover:bg-gray-200 p-2 mb-2'> <HiViewGridAdd className='w-5 h-5' /><span>My Enrolled Classes</span></Link>
                            </>
                            )
                    )}
                </ul>

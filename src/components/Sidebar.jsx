                        ...
                        <nav>
                            <>
                                ...
                                >
                                    ...
                                    />
                                    <span className='px-4 py-1 rounded-l-md bg-fuchsia-950 peer-checked:bg-gray-300 peer-checked:text-gray-700 text-white'>
                                        Student
                                    </span>
                                    <span className='px-4 py-1 rounded-r-md bg-gray-300 peer-checked:bg-fuchsia-950
